		...
		do
		{
			...
			System.out.print("\n\n Olá, Bem vindo ao programa: Energia, um Ciclo Responsável! ");
...

				{
					...
					Fisica fisica = new Fisica (nome, telefone, endereco, numeroInstalacao, valorConta, kgLixo, cpf, renda);
			
					Juridica juridica = new Juridica (nome, telefone, endereco, numeroInstalacao, valorConta, kgLixo, cnpj, renda);
